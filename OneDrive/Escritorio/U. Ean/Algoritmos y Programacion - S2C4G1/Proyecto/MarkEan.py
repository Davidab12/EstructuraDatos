        ...
        while action != "0":
            ...
            if name.upper() == "C":
                ...
                if check == True:
                    ...
                    unidades = input("Unidades a comprar: ")
                    if unidades.isnumeric() == True:

                        if int(unidades) <= products[code][4]:
                            iva += (products[code][3]*int(unidades))*0.19
                            subtotal += (products[code][3]*int(unidades))-((products[code][3]*int(unidades))*0.19)
                            total += products[code][3]*int(unidades)
                            listaBuy.append([code,products[code][1],products[code][3], int(unidades), products[code][3]*int(unidades)])
                            delUnit.append([code,int(unidades)])
                            ...
                            if action == "2":
                                ...
                                idClient = input("Id de cliente: ")
                                if idClient.isnumeric() == True:
                                    ...
                                    print('\nERROR 401 | El id cliente debe ser numeros enteros')
                                    break
                        ...
                        print("\nERROR 401 | La cantidad debe ser un numero entero")
                else:
