...
internal class TallerRecursionKtTest {
    ...
    fun probarContarVerbos() {
        ...
        //assertEquals(0, TList("nada", "come", "papa"))
        /* Corrección de la linea anterior */
        assertEquals(0, contarVerbos(TList("nada", "come", "papa")))
    }
    ...
    fun probarbuscarElementoEnUnaLista() {
        ...
        /*Corrección de la línea anterior, ya que el elemento 43 se encuentra en la posición 6*/
        assertEquals(6, buscarElementoEnUnaLista(TList(40, 12, 18, 57, 1, 198, 43, 33, 12), 43))
    ...
    fun probarPuntosPrimerCuadrante() {
        ...
        /* Corrección de la línea anterior, la función pide una lista de puntos en el primer cuadrante, no pide el número de puntos en el primer cuadrante */
        val lp: IList<Punto>
            =   TList(Punto(3, 4), Punto(2, -1), Punto(-5, -10), Punto(5, 6), Punto (-2, 2))

        assertEquals(TList(Punto(3, 4), Punto(5, 6)), puntosPrimerCuadrante(lp))
    }
